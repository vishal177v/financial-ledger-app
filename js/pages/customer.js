    ...
    <div class="page kb-page" id="customer-page">
      ...
      <header class="kb-header">
        ...
        <div style="display:flex; gap:4px;">
          <a href="tel:${_customer.phone.replace(/\D/g, '')}" class="kb-icon-btn" title="Call Customer">
          ...
          <button class="kb-icon-btn" id="delete-customer-btn" title="Delete Customer" style="color: var(--red);">
            ${ICON_DELETE_SM}
          </button>
        </div>
      </header>
